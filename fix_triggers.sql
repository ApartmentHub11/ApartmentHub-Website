-- The column `is_required` was removed from the `documenten` table.
-- However, several database triggers still reference `d.is_required = true`.
-- Run this SQL in your Supabase SQL Editor to update the triggers and fix the "column d.is_required does not exist" error.
